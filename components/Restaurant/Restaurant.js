...
import { Alert, Button, StyleSheet, Image, View, Text, TouchableOpacity,
    DrawerLayoutAndroid,  Dimensions, Slider, TextInput, CheckBox,ScrollView, Modal, StatusBar } from 'react-native';
...
import RegisterEstabelecimento from '../RegisterRestaurant/RegisterEstabelecimento';
            ...
            >
               ...
               <View style = {{
                  ...
                  <TouchableOpacity onPress = {() => {
                     ...
                     {Alert.alert('Filtros','Não Disponiveis');}
                    }}
                     style = {{ 
                          borderColor: '#a6a6a6', width: screen.width-50,
                          borderStyle: 'solid',
        ...
        var modalUser = (
               <Modal transparent={true}
                    ...
                    <View style={styles.modalUserIcon}>
                        ...
                        <TouchableOpacity onPress={()=>{Alert.alert('Página Restaurante','Não Disponivel');}} activeOpacity={0.9} style={{ position: 'absolute', bottom: '25%', left: '5%'} }>
                            <View style={{flexDirection: 'row' }}>
        ...
        return (
            <View style={{flex:1}}>
                <View style={styles.mainheader} >
                        ...
                        <TouchableOpacity onPress={()=>{Alert.alert('A Minha Conta','Não Disponivel');}} activeOpacity={0.9} style={{  position: 'absolute', bottom: '80%', left: '5%', } }>
                            <View style={{flexDirection: 'row' }}>
                                < SimpleLineIcons name="home" size={20} style={{ top: '5%' }} />
                                <Text style={styles.modalText}> A Minha Conta </Text>
                            </View>
                            ...
                            <TouchableOpacity onPress={()=>{Alert.alert('Meus Estabelecimentos','Não Disponivel');}} activeOpacity={0.9} style={{  position: 'absolute', bottom: '63%', left: '5%', } }>
                                <View style={{flexDirection: 'row' }}>
                                    < MaterialCommunityIcons name="silverware-variant" size={20} style={{ top: '5%' }} />
                                    <Text style={styles.modalText}> Meus Estabelecimentos </Text>
                                </View>
                            ...
                            <TouchableOpacity onPress={()=>{Alert.alert('Definições','Não Disponivel');}} activeOpacity={0.9} style={{ position: 'absolute', bottom: '25%', left: '5%'} }>
                                <View style={{flexDirection: 'row' }}>
                                    < SimpleLineIcons name="settings" size={20} style={{ top: '10%' }} />
                                    <Text style={styles.modalText}> Definições </Text>
                                </View>
